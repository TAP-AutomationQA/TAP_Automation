...
public class TC52RoundTripDirectByAirportTest {
	...
	public void test() throws InterruptedException{
		...
		BookingSearchPage.txtFrom(driver).sendKeys("COSTA DEL SOL AIRPORT");
		Thread.sleep(3000);
		BookingSearchPage.autocomplete(driver).click();
		
		
		BookingSearchPage.txtTo(driver).click();
		BookingSearchPage.txtTo(driver).sendKeys("ADOLFO SUAREZ BARAJAS");
		Thread.sleep(3000);
		BookingSearchPage.autocomplete(driver).click();
