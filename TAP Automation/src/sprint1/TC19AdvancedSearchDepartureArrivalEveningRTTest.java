...
public class TC19AdvancedSearchDepartureArrivalEveningRTTest {
	...
	public void test() throws InterruptedException{
		...
		BookingSearchPage.selectOutboundDeparture(driver, "Evening");
		BookingSearchPage.selectOutboundArrival(driver, "Evening");
		BookingSearchPage.selectInboundDeparture(driver, "Evening");
		BookingSearchPage.selectInboundArrival(driver, "Evening");
		Thread.sleep(3000);
