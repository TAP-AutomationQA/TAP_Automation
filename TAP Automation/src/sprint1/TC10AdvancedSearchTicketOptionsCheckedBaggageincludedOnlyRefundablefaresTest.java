...
public class TC10AdvancedSearchTicketOptionsCheckedBaggageincludedOnlyRefundablefaresTest {
	...
	public void test() throws InterruptedException{
		...
		BookingSearchPage.chkCheckBagInc(driver).click();
		BookingSearchPage.chkOnlyRefFares(driver).click();
