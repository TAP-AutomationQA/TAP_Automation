...
public class TC17AdvancedSearchDepartureArrivalMorningRTTest {
	...
	public void test() throws InterruptedException{
		...
		BookingSearchPage.selectOutboundDeparture(driver, "Morning");
		BookingSearchPage.selectOutboundArrival(driver, "Morning");
		BookingSearchPage.selectInboundDeparture(driver, "Morning");
		BookingSearchPage.selectInboundArrival(driver, "Morning");
		Thread.sleep(3000);
