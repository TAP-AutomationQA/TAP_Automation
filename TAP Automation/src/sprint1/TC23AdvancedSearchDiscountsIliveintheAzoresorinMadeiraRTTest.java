...
public class TC23AdvancedSearchDiscountsIliveintheAzoresorinMadeiraRTTest {
	...
	public void test() throws InterruptedException{
		...
		BookingSearchPage.txtFrom(driver).sendKeys("PDL");
		Thread.sleep(3000);
		BookingSearchPage.autocomplete(driver).click();

		BookingSearchPage.txtTo(driver).click();
		BookingSearchPage.txtTo(driver).sendKeys("FNC");
		Thread.sleep(3000);
		BookingSearchPage.autocomplete(driver).click();
		
		BookingSearchPage.lnktxtShowAdvSearch(driver).click();
		BookingSearchPage.chkResidentDiscount(driver).click();
