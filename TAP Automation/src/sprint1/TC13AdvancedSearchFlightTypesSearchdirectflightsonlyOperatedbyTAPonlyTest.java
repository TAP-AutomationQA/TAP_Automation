...
public class TC13AdvancedSearchFlightTypesSearchdirectflightsonlyOperatedbyTAPonlyTest {
	...
	public void test() throws InterruptedException{
		...
		BookingSearchPage.chkSearchDirFlgOnly(driver).click();
		BookingSearchPage.chkOprByTAPOnly(driver).click();
		Thread.sleep(3000);
