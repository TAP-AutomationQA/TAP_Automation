...
public class TC18AdvancedSearchDepartureArrivalAfternoonRTTest {
	...
	public void test() throws InterruptedException{
		...
		BookingSearchPage.selectOutboundDeparture(driver, "Afternoon");
		BookingSearchPage.selectOutboundArrival(driver, "Afternoon");
		BookingSearchPage.selectInboundDeparture(driver, "Afternoon");
		BookingSearchPage.selectInboundArrival(driver, "Afternoon");
		Thread.sleep(3000);
